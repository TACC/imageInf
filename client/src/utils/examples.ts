...
export const designsafeCuratedFileList: TapisFile[] = [
  ...
  {
    /*PRJ-2113 | StEER - Hurricane MichaelPRJ-3442 | RAPID/GEER Phase 2 Reconnaissance Mission: Western European Floods Summer 2021*/
    systemId: 'designsafe.storage.published',
    path: '/PRJ-3442v2/RAPID_EF/3_Deliverables/Mayschoss/Imagery/0329-pedbridge-mayschoss_s1_compass_4xC16L-A_11.jpg',
  },
  {
    /*PRJ-3252 | GEER reconnaissance mission: Western European Floods Summer 2021    */
    systemId: 'designsafe.storage.published',
    path: '/PRJ-3252/Germany (August 9-13, 2021)/Sinzig (August 12)/Photos/MGeorge/PXL_20210812_101136279.jpg',
  },
  {
    /*PRJ-3252 | GEER reconnaissance mission: Western European Floods Summer 2021    */
    systemId: 'designsafe.storage.published',
    path: '/PRJ-3252/Germany (August 9-13, 2021)/Sinzig (August 12)/Photos/MGeorge/PXL_20210812_110558490.jpg',
  },
  {
    /*PRJ-3252 | GEER reconnaissance mission: Western European Floods Summer 2021    */
    systemId: 'designsafe.storage.published',
  ...
  {
    /*PRJ-3269 | StEER - 14 August 2021, M7.2 Nippes Earthquake, Haiti*/
    systemId: 'designsafe.storage.published',
    path: '/PRJ-3269/D1. Performance Assessments/Images/0002898c-8807-44e6-94cd-afeb959d13fb.jpg',
  },

  /* Can use to check error handling
  { // fake wrong data
    systemId: 'designsafe.storage.published',
    path: '/PRJ-bar/foojpg',
  },*/
